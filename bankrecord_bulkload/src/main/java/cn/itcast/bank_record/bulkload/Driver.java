package cn.itcast.bank_record.bulkload;


import cn.itcast.bank_record.bulkload.mr.BankRecordMapper;
...
public class Driver {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
       ...
       //i.	FileInputFormat.setInputPaths
        FileInputFormat.setInputPaths(job,new Path("hdfs://node1:8020/bank/input"));
        //ii.	FileOutputFormat.setOutputPath
       // JobConf jobConf = new JobConf(configuration);
        FileOutputFormat.setOutputPath(job,new Path("hdfs://node1:8020/bank/output"));
